<template>
  <div
    v-if="width > 768"
    id="sideMenu"
    class="collapse collapse-horizontal show mt-2"
  >
    <div id="sideMenu-nav" class="list-group border-0">
      ...
      >
        <RouterLink :to="`/user/${user.uid}`" class="nav-link d-inline-flex">
          <span class="float-start fs-3 mdi mdi-home-account"></span
          ><b class="my-auto ms-4">User Tasks</b>
        </RouterLink>
      </li>
      ...
      >
        <RouterLink to="/" class="nav-link d-inline-flex">
          <span class="float-start fs-3 mdi mdi-home"></span
          ><b class="my-auto ms-4">All Tasks</b>
        </RouterLink>
      </li>
      ...
      >
        <RouterLink :to="`/${tag}`" class="nav-link d-inline-flex">
          <span class="float-start fs-3 mdi mdi-pound"></span
          ><b class="my-auto ms-4">{{ tag }}</b>
        </RouterLink>
      </li>
    </div>
  </div>
